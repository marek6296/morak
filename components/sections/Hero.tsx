  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="lg:hidden">
        <div className="relative h-[92svh] min-h-[600px]">
          <Image
            src="https://images.unsplash.com/photo-1624397640148-949b1732bb0a?w=900&q=85&auto=format&fit=crop"
          ...
          />
          {/* Gradient — transparent top, heavy dark at bottom */}
          <div className="absolute inset-0 bg-gradient-to-t from-ink-900/95 via-ink-900/50 to-ink-900/10" />
          ...
          <div className="absolute inset-x-0 bottom-0 px-5 pb-9">
            ...
            >
              {/* Eyebrow badge */}
              <span className="inline-flex w-fit items-center rounded-full border border-brand/30 bg-brand/20 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-brand-200 backdrop-blur-sm">
                Zelená domácnostiam · Dotácia až 7 500 €
              </span>

              {/* Headline */}
              <h1 className="font-display text-[2.1rem] font-semibold leading-[1.13] tracking-tight text-white">
                Elektrina, ktorú si vyrábate sami.
              </h1>

              {/* Short subtext */}
              <p className="text-[15px] leading-relaxed text-ink-200">
                Znížte účet za elektrinu až o&nbsp;80 %. Certifikovaný tím,
                päťročná záruka, dotáciu vybavíme za vás.
              </p>

              {/* Primary CTA — full width, prominent */}
              <Link
                href="/kontakt"
                className="btn-primary mt-1 w-full justify-center py-4 text-base"
              >
              ...
              <Link
                href="#sluzby"
                className="text-center text-sm font-medium text-ink-300 transition-colors hover:text-white"
              >
                Pozrieť naše služby ↓
              </Link>

              {/* Trust strip */}
              <div className="flex items-center gap-3 rounded-2xl border border-white/12 bg-white/8 px-4 py-3 backdrop-blur-md">
                <span className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-brand/25 text-brand-300">
                  <ShieldIcon size={15} />
                </span>
                <p className="text-[13px] leading-snug text-ink-100">
                  <span className="font-semibold text-white">5-ročná záruka na montáž</span>
                  <span className="text-ink-300"> · oprávnenie §22 / §23</span>
                </p>
              </div>
            </motion.div>
          </div>
