...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-0 md:pt-2">
      ...
      <div className="container-lg relative">
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -left-5 top-8 hidden rounded-2xl border border-ink-900/10 bg-white p-4 shadow-lift sm:block"
            >
        ...
        <div className="mt-12 border-t border-ink-900/10 pt-6">
          ...
          <div className="mt-5 grid grid-cols-2 items-center gap-6 opacity-80 sm:grid-cols-3 md:grid-cols-6">
